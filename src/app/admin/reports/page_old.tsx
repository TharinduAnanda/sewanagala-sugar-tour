...
export default function AdminReportsPage() {
  ...
  const fetchReportData = async () => {
    try {
      ...
      // For now, using mock data since the reports API might not be fully implemented
      ...
      const mockData: ReportData = {
        ...
        topDates: [
          { date: '2025-03-15', bookings: 12, visitors: 45 },
          { date: '2025-03-10', bookings: 10, visitors: 38 },
          { date: '2025-03-05', bookings: 9, visitors: 32 }
        ]
      }
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold">LKR {reportData.overview.totalRevenue.toLocaleString()}</p>
                        <p className="text-sm text-green-600 flex items-center gap-1 mt-1">
                          <FaArrowUp />
                          8% increase
                        </p>
