...
export default function BookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (totalVisitors > 100) {
      setError('Maximum 100 visitors per booking. For larger groups with special requirements, please use the special request form below.')
      return
    }
            ...
            <Card className="shadow-lg">
              <CardContent className="p-4 sm:p-6 md:p-8">
                ...
                >
                  ...
                  <p className="text-muted-foreground">Your factory tour has been successfully reserved</p>
                </motion.div>
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl sm:text-4xl md:text-5xl font-bold mb-3">Book Your Factory Tour</h1>
